...
// Below are just helper methods that don't do anything other than enable the goofy
// syntax in the method above. Most of them do nothing, I was just feeling silly
// when I was working on the switchGameMode method.
